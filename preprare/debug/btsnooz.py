...
# Copy https://android.googlesource.com/platform/system/bt/+/oreo-dev/tools/scripts/btsnooz.py
"""
...
def decode_snooz_v1(decompressed, last_timestamp_ms):
    ...
    while offset < len(decompressed):
        ...
        sys.stdout.write(struct.pack('>II', (first_timestamp_ms >>
                         32), (first_timestamp_ms & 0xFFFFFFFF)))
